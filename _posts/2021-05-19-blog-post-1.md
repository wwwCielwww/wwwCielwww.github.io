...
💙 Shortest path between $v_s$ and $v_t \to p_{st}=\text{arg min}_{p\in\mathcal{P}_{st}}\vert p\vert$, where $\mathcal{P}_{st}$ denotes the set of all paths between the two vertices.
